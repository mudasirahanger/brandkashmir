<?php
// HTTP
define('HTTP_SERVER', 'http://brandkashmir.local/admin/');
define('HTTP_CATALOG', 'http://brandkashmir.local/');

// HTTPS
define('HTTPS_SERVER', 'http://brandkashmir.local/admin/');
define('HTTPS_CATALOG', 'http://brandkashmir.local/');

// DIR
define('DIR_APPLICATION', 'C:/xampp/htdocs/nad/html2pdf/brandkashmir/admin/');
...
define('DIR_CATALOG', 'C:/xampp/htdocs/nad/html2pdf/brandkashmir/catalog/');
